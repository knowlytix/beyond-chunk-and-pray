# Contributing to groundloop

Thanks for your interest in contributing! This repository is the **open**
(groundloop) part of the project — it runs with no license. The advanced GMS
...
```bash
git clone https://github.com/knowlytix/beyond-chunk-and-pray.git
cd beyond-chunk-and-pray
